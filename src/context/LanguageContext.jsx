...
const translations = {
  en: {
    ...
    paymentTotalLabel: "Total to pay",
    paymentDisclaimer: "You will complete this payment using Mercado Pago.",
    paymentStartButton: "Pay",
    paymentLoadingCheckout: "Opening checkout...",
    paymentStartError: "Could not start Mercado Pago checkout. Please try again.",
    paymentSaveError: "Could not save payment result. Please try again.",
    paymentMissingTrip: "Trip not found for payment.",
    paymentPendingTitle: "Payment pending",
    paymentPendingMessage: "Your payment is pending confirmation. You can try again in a moment.",
    paymentRejectedTitle: "Payment not approved",
    paymentRejectedMessage: "Your payment was not approved. Please use another method.",
  },
  es: {
    ...
    paymentDisclaimer: "Completarás este pago usando Mercado Pago.",
    paymentStartButton: "Pagar",
    paymentLoadingCheckout: "Abriendo checkout...",
    paymentStartError: "No se pudo iniciar el checkout de Mercado Pago. Intenta nuevamente.",
    paymentSaveError: "No se pudo guardar el resultado del pago. Intenta nuevamente.",
    paymentMissingTrip: "No se encontró el viaje para el pago.",
    paymentPendingTitle: "Pago pendiente",
    paymentPendingMessage: "Tu pago está pendiente de confirmación. Puedes intentar de nuevo en un momento.",
    paymentRejectedTitle: "Pago no aprobado",
    paymentRejectedMessage: "Tu pago no fue aprobado. Intenta con otro método.",
  },
}
